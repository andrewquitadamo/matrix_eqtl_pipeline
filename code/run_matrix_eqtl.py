...
def get_args():
    ...
    parser.add_argument('-v','--p-value',nargs='?', help='')
    ...
    return(args.genotype_matrix, args.genotype_positions, args.gene_expression_matrix, args.gene_positions, args.covariates, args.output_file, float(args.p_value), args.qq_plot)
